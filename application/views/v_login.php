	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url()?>assets/login/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?= base_url('Login/verify_login')?>" method="post">
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="<?php echo base_url()?>Login/register_view" style="color:white">

  ...
  <!--Section: Best Features-->
    ...
    <div class="row">
      ...
      <section id="product-offer" style="margin-top:100px;">
        <h1  class="text-center">Our Hotel Offer</h1>
        <p class="text-center">Find the best room for your staycation here in Batu.</p>
    
		<form action="<?php echo base_url('Places/search_hotel')?>" method="POST">
...
<div id="demo" class="collapse filteredSearch">
		<div class="text-center">
		Harga minimum
        <input type="text" class="sliderValue" data-index="0" value="300000" name="hmin" />
				<i class="fas fa-minus"></i>
        <input type="text" class="sliderValue" data-index="1" value="2000000" name="hmax"/>
		Harga maksimum
    <div id="slider"></div>
		</div>
  ...
  <label class="form-check-label">
	...
	<div class="form-check">
        ...
        <div class="row row-offer">
				...
				<?php foreach ($data_hotel as $data) : ?>
                ...
                <div class="card-images">
                  <img class="card-img-top" src="<?php echo base_url()?>assets/images/wisata/<?= $data->img_place?>" alt="Card image cap">
                    ...
                    <div class="card-body" style="min-height:200px">
										<a href="<?php echo base_url().'index.php/Places/lihat_detail/'.$data->id_place?>" class="link-place">
                         <h5 class="card-title" style="color:black"><?= $data->nama_place ?></h5>
												 </a> <br>
												 <?php
												 if($data->rating == 1){?>

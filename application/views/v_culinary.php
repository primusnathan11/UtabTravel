  ...
  <!--Section: Best Features-->
    ...
    <div class="row">
      ...
      <section id="product-offer" style="margin-top:100px;">
        <h1  class="text-center">Our Culinary offer</h1>
        <p class="text-center">Find the best food and beverages that Batu can offer.</p>
    
		<form action="<?php echo base_url('Places/search_culinary')?>" method="POST">
  ...
  <label class="form-check-label">
	...
	<div class="form-check">
        ...
        <div class="row row-offer">
				...
				<?php foreach ($data_culinary as $data) : ?>
